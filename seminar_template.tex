...
This is a modified version of the IEEE template for conference proceedings that you can use for
...
\subsection{Network}
Access Technologie from LTE point of view
...
\subsection{V2X versus DSRC}
\subsection{Usability or something}
