...
\begin{table}[h!]
  ...
  \caption{V2X Services Grouped into Four Major Categories \cite{machardy2018} - Applications and Requirements}
    ...
    \begin{tabular}{ccc}
      ...
      \hline
      \textbf{\makecell{Infotainment}}& \makecell[c]{as} & \makecell[c]{as}\\
      \textbf{\makecell{Traffic Efficency}}& \makecell[c]{asd} & \makecell[c]{asd} \\
      \textbf{\makecell{Traffic Safety}}& \makecell[c]{asd} & \makecell[c]{asd} \\
       \textbf{\makecell{Cooperative Driving}}& \makecell[c]{asd} & \makecell[c]{asd}\\
    \end{tabular}
  \end{center}
\end{table}
