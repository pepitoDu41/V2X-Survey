...
\begin{table}[h!]
  ...
  \caption{V2X Services Grouped into Four Major Categories \cite{machardy2018} - Applications and Requirements}
    ...
    \begin{tabular}{ccc}
      ...
      \\
      \textbf{\makecell{Traffic Efficency}}& \makecell[c]{Optimizing traffic flow \\ Intersection timing \\ Real time route planning} & \makecell[c]{Constant information exchange\\ Usually not safety critical\\ Medium latency \\ Medium throughput} \\
      \\
